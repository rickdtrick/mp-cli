...
describe('CartItem', () => {
  ...
  describe("all", () => {
    it('should return all cart items', () => {
      (readFileSync as jest.Mock).mockReturnValue(JSON.stringify(mockCartItems));
  ...
  describe('create', () => {
    it('should create a new cart item and return it', () => {
      ...
      expect(writeFileSync).toHaveBeenCalledWith(filePath, JSON.stringify([...mockCartItems, newCartItem]));
    })
